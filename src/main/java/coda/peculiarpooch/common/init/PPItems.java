...
public class PPItems {
    ...
    // Spawn Eggs
    public static final RegistryObject<Item> BORZOI_SPAWN_EGG = ITEMS.register("borzoi_spawn_egg", () -> new PPSpawnEggItem<>(PPEntities.BORZOI, 0xf8f4e0, 0xb2a387, new Item.Properties().tab(ItemGroup.TAB_MISC)));
}
